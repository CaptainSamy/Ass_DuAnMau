...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hoadon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent c = new Intent(HomeActivity.this, ListHoaDonActivity.class);
                startActivity(c);
            }
        });
        thongke.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent d = new Intent(HomeActivity.this, ThongKeDoanhThuActivity.class);
                startActivity(d);
            }
        });
        sachbanchay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent e = new Intent(HomeActivity.this, LuotSachBanChayActivity.class);
                startActivity(e);
            }
        });
    }
