...
import com.example.ass_duanmau.model.HoaDon;
...
public class HoaDonChiTietDAO {
    ...
    public List<HoaDonChiTiet> getAllHoaDonChiTiet(){
        ...
        String sSQL = "SELECT maHDCT, HoaDon.maHoaDon,HoaDon.ngayMua, " + "Sach.maSach, Sach.maTheLoai, Sach.tenSach, " +
                "Sach.tacGia, Sach.NXB, Sach.giaBia, " + "Sach.soLuong,HoaDonChiTiet.soLuong FROM HoaDonChiTiet " +
    ...
    public List<HoaDonChiTiet> getAllHoaDonChiTietByID(String maHoaDon){
        List<HoaDonChiTiet> dsHoaDonChiTiet = new ArrayList<>();
        String sSQL = "SELECT maHDCT, HoaDon.maHoaDon,HoaDon.ngayMua, " + "Sach.maSach, Sach.maTheLoai, Sach.tenSach, Sach.tacGia, Sach.NXB, " +
                "Sach.giaBia, " + "Sach.soLuong,HoaDonChiTiet.soLuong FROM HoaDonChiTiet INNER JOIN HoaDon " +
    ...
    public double getDoanhThuTheoThang(){
        ...
        String sSQL ="SELECT SUM(tongtien) from (SELECT SUM(Sach.giaBia * HoaDonChiTiet.soLuong) as 'tongtien' " +
                ...
                "where strftime('%m',HoaDon.ngayMua) = strftime('%m','now') GROUP BY HoaDonChiTiet.maSach)tmp";
        Cursor c = db.rawQuery(sSQL, null);
        c.moveToFirst();
        while (c.isAfterLast()==false){
            doanhThu = c.getDouble(0);
